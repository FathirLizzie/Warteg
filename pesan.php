...
if (isset($_GET["jenis_Makanan"]) && isset($_GET["jumlahMakanan"])) {
  $jenis_makanan = $_GET["jenis_Makanan"];
  $jumlahMakanan = (int)$_GET["jumlah_Makanan"];
}

/*
$totalHarga = $hargaMakanan * $jumlahMakanan;

echo "<p>Anda Memesan $jumlahMakanan porsi $jenisMakanan seharga Rp. "
.number_format($hargaMakanan, 0, ",", ".")." per porsi.</p>"
            ...
            <input type="hidden" value="<?php echo $id; ?>" name="id">
              ...
              <div class="row mt-3">
			          <div class="col">
			            ...
			            <input type="number" class="form-control" id="jumlahMakanan" min="1" value="1">
			          </div>
		          </div>
